define([
  ...
  var Router = Backbone.Router.extend({
     ...
     */
    home: function () {
      require(['Pi/start/startFinder'], function (Pi) {
    ...
    openProject: function (id, action, tabId) {
      require([
        ...
        // console.log(id, projectId, action, tabId)
    ...
    activated: function () {
      if (Pi.user.isGuest()) {
        require(['Pi/start/startDialogs'], function (Pi) {
          Pi.dialog.open({
            dataId: 'shortMessage',
            title: 'Your account is ready',
            content:
              "Your account has been activated.<br>You can finally <i class='icon-signin'></i> <a href='#log-in'>Log In</a>."
          })
        })
      } else {
        this.goHome()
      ...
      if (Pi.user.isGuest()) {
        require(['Pi/start/startDialogs'], function (Pi) {
          Pi.dialog.open({
            ...
            content:
              "Your account is already active.<br>You can <i class='icon-signin'></i> <a href='#log-in'>Log In</a>."
          })
        })
      } else {
        this.goHome()
  ...
  Pi.router.route('project/:id(/:action)(/:tabId)(/)', 'openProject')
