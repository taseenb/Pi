...
<script>
	define('Pi', function() {
		var Pi = {
			...
			maxIdeSessions: 10, // max number of ide windows open at the same time
			...
			defaultDesktopImage: "", //"<?php //echo $t;                  
																	?>/img/bg/gradient_autumn.jpg",
			defaultDesktopColor: "",
			...
			sandbox: "<?php echo app()->params['sandbox'] ?>",
								...
								<div class="row">
									<div class="span12">
										...
										<p>Pi is dedicated to creative coders, artists and designers.
											...
											and animations written in javascript and the <a href='http://processing.org/' target="_blank" rel="noopener noreferrer">Processing</a>
											language.</p>
										<p>Pi currently uses the magical javascript port of Processing,
											<a href='http://processingjs.org/' target="_blank" rel="noopener noreferrer">Processing JS</a>.
											Other libraries (like <a href='http://paperjs.org/' target="_blank" rel="noopener noreferrer">Paper.js</a>,
											<a href="http://threejs.org/" target="_blank" rel="noopener noreferrer">Three.js</a>, etc.)
										...
										<p><strong>Pi is still under heavy development.
												...
												known and unknown <a href="https://github.com/taseenb/Pi/issues" target="_blank" rel="noopener noreferrer">bugs</a>.
